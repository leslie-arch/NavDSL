...
@registry.register_dataset(name="ObjectNav-HM3D-v1")
    ...
    def from_json(
        ...
        for i, episode in enumerate(deserialized["episodes"]):
            ...
            if scenes_dir is not None:
                ...
                scene_config = pathlib.Path(episode.scene_id)
                episode.scene_dataset_config = os.path.join(scene_config.parent.parent.parent,
                                                            os.path.basename(episode.scene_dataset_config))
